...
Future<List<InterviewReport>> fetchInterviewReports() async {
  ...
  return [
    InterviewReport(
      ...
      topics: [
        "Dart Language", "OOP", "Data Structures", "Dart Mixins",
    ...
    InterviewReport(
      ...
      topics: [
        "Kotlin", "Generics", "Nested Classes", "Abstract Classes", "Functional Programming"
      ],
    ...
    InterviewReport(
      ...
      topics: [
        "C++ Syntax", "Data Types", "Variables", "Operators", "Control Structures"
      ],
