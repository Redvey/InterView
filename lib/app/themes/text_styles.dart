...
class AppTextStyles {
  ...
  static TextStyle infoSmallHeader(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    fontSize: context.fontSizeSx,
    fontWeight: FontWeight.w600,
  );
  ...
  static TextStyle buttonWhiteText(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    fontWeight: FontWeight.w500,
    fontSize: context.fontSizeSs,
  ...
  //modal bottom sheet
  static TextStyle subscriptionTitle(BuildContext context) => TextStyle(
  ...
  //dialog box
  static TextStyle dialogBoxTitle(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
  ...
  static TextStyle dialogBoxSubTitle(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    color: AppColors.backgroundWhite,
    fontSize: context.fontSizeSm,
    fontWeight: FontWeight.w400,
  ...
  static TextStyle membershipDetail(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    fontSize: context.fontSizeSs,
    color: AppColors.backgroundYellow,
    fontWeight: FontWeight.w400,
  );
  static TextStyle membershipOldMoney(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    fontSize: context.fontSizeSs,
  ...
  static TextStyle membershipNewMoney(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    fontSize: context.fontSizeSs,
    color: AppColors.buttonYellow,
    fontWeight: FontWeight.w400,
  ...
  static TextStyle snackBarText(BuildContext context) =>
      TextStyle(fontSize: context.fontSizeSms, fontFamily: AppFonts.poppins);
  ...
  static TextStyle interviewReportsTitle(BuildContext context) => TextStyle(
    fontSize: context.fontSizeMd,
    fontFamily: AppFonts.poppins,
    fontWeight: FontWeight.w600,
    color: Colors.black,
  ...
  static TextStyle dateHeader(BuildContext context) => TextStyle(
    fontSize: context.fontSizeSm,
    fontFamily: AppFonts.poppins,
    fontWeight: FontWeight.w600,
  ...
  static TextStyle roleTitle(BuildContext context) => TextStyle(
    fontSize: context.fontSizeSx,
    fontFamily: AppFonts.poppins,
    fontWeight: FontWeight.w500,
    color: AppColors.blackLight,
  ...
  static TextStyle topicSummary(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
  ...
  static TextStyle interviewInformationTitle(BuildContext context) => TextStyle(
    fontFamily: AppFonts.poppins,
    color: AppColors.backgroundWhite,
    fontSize: context.fontSizeSm,
    fontWeight: FontWeight.w600,
