...
class AppColors {
  ...
  static const Color backgroundLightBlue = Color(0xFFFFCBCB); // This was previously 'backgroundLightBlue', but the color value was for light pink. Renamed to avoid confusion with textBlueBg.
  static const Color backgroundGrey = Color(0xFFF5F5F5); // From second set of duplicates
  static const Color backgroundLightBlue2 = Color(0xFFE3F2FD); // From second set of duplicates, renamed to avoid conflict
  ...
  static const Color chipBackground = Color(0xFFF5F5F5); // From second set of duplicates
  static const Color chipBorder = Color(0xFFE0E0E0); // From second set of duplicates
  ...
  static const Color blackLight = Color(0xFF1E1E1E); // Also an accent color in duplicates
  ...
  static const Color textGrey = Color(0xFF757575); // Also textSecondary in duplicates
  ...
  static const Color textGreen = Color(0xFF9BFF94); // Also a success color in duplicates
  static const Color textGreenBg = Color(0xFFE7FFF1); // Also successLight in duplicates
  ...
  static const Color textPrimary = Color(0xFF212121); // From second set of duplicates
  static const Color textWhite = Color(0xFFFFFFFF); // From second set of duplicates
  static const Color textGrey2 = Color(0xFF9E9E9E); // From second set of duplicates, renamed to avoid conflict
  ...
  // --- Accent Colors ---
  static const Color greyLight = Color(0xFFE0E0E0); // From second set of duplicates
  static const Color greyMedium = Color(0xFFBDBDBD); // From second set of duplicates
  static const Color greyDark = Color(0xFF616161); // From second set of duplicates
  ...
  static const Color black87 = Color(0xDD000000); // Colors.black87 (87% opacity of black)
  static const Color red = Color(0xFFF44336);    // Colors.red (default Material red)
